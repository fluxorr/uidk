        ...
        <nav className="" >
            <div className="flex justify-center gap-40 items-center py-4 text-white/50   " >
                ...
                <div className="flex gap-8 items-center  border-white/15 rounded-full border-1 px-12 py-3 " >
                    <div className="flex items-center gap-2 cursor-pointer" >Features <DropDown /></div>
                    <div className="cursor-pointer" >Developers</div>
                    <div className="flex items-center gap-2 cursor-pointer" >  Company <DropDown /></div>
                    <div className="cursor-pointer" >Blog</div>
                    <div className="cursor-pointer" >Changelog</div>
                </div>


                <button className="border-1  text-white/60 hover:scale-101 transition-transform duration-300 border-neutral-100/40 w-fit h-fit px-1 py-1 rounded-[14px] cursor-pointer" ><div className=" px-2 py-1 border-1 border-neutral-100/40  inset-0  bg-[#843afc] rounded-[10px] backdrop-blur-xs" >Join Waitlist</div></button>
