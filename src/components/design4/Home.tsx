...
function Home() {
    return (
        <div className="flex flex-col justify-center items-center mt-32 z-[999] "  >
            ...
            <div style={{ zIndex: "100" }} className=" font-medium text-[102px] leading-[94px] text-center tracking-[-0.0506em] bg-gradient-to-b from-white to-[#B372CF] bg-clip-text text-transparent z-0 pb-4" >
                <div>Boost Your </div>
            ...
            <img src={Mock3} alt="mock image of platform" style={{ zIndex: "100" }} />
