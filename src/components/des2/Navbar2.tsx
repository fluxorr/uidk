  ...
  return (
    <div className="my-8 flex items-center  text-white text-center justify-between px-6">
      <div className="flex justify-center items-center ">
        ...
        <div className="flex  items-center justify-center  ml-4 md:ml-12 lg:ml-18 gap-2 md:gap-4 lg:gap-6 text-md  text-neutral-200">
      ...
      <div className="flex gap-4  items-center justify-center  ">
        ...
        <button className=" rounded-full bg-white text-black text-shadow-2xs hover:scale-99 text-shadow-white text-xs md:text-sm py-2 px-8 hover:bg-neutral-200 transition cursor-pointer ">
          Download Now
        </button>
      </div>
    </div>
