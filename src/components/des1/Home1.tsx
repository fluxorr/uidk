...
import desgin1 from "../../assets/design1.png"

const Home1 = () => {
    const element = document.documentElement;
    useEffect(() => {
        if (desgin1) {
            element.style.backgroundImage = `url(${desgin1})`;
    ...
    return (
        <div className="flex flex-col gap-4 items-center p-4">
            ...
            <div className="text-[rgb(99,95,48)] text-lg sm:text-xl text-center max-w-4xl">
